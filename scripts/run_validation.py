    ...
    return [
        ...
        Layer("L3 integration (project)", [
            ...
            Step("schema and ingestion pipeline tests", [py, "-m", "pytest",
                 ...
                 "tests/test_chunk_pipeline.py", "tests/test_epic6_traceability.py",
                 "tests/test_epic8_evaluation.py", "tests/test_epic9_matrix_gaps.py",
                 "tests/test_epic10_findings.py", "tests/test_epic11_report.py",
                 "tests/test_epic12_dashboard.py",
                 "tests/test_epic13_validation.py",
                 "-q", "-p", "no:cacheprovider"], cwd=ENCONET),
            Step("live finding/action validator", [py, str(ENCONET / "scripts" / "validate_findings.py")]),
            Step("phase-aware dashboard validator", [py, str(ENCONET / "scripts" / "validate_dashboard.py"), "--no-record"]),
            Step("EPIC13 project aggregate", [py, str(ENCONET / "scripts" / "run_all_validations.py"), "--no-record"]),
