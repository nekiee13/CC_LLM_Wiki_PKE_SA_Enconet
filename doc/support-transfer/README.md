...
| `staged/` | Staged coordination-validator and handoff-publisher prototypes plus disposable-root positive/fault-injection tests (T4.1-artifact, T4.3, T5.2, T6.4 evidence) | T6-R1..R7 corrected; pending Codex re-review |
| `T6_STAGED_EXECUTABLE_CHECKPOINT.md` | Staged-executable evidence, 63/63 passing tests, T6-R1..R7 corrections, and explicit pending boundary | Pending Codex re-review |
