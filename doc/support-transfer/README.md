...
| `SLICE1_PREJOB_BRIEFING.md` | Slice-1 v5 single scope: 8 creates, exceptional replacement, two-commit protocol with literal commands, deterministic event times, final-B validation | Recorded; awaiting Codex re-review before re-implementation (rejected local commit `80f8730` superseded, unpushed) |
