...
| `staged/` | Staged coordination-validator and handoff-publisher prototypes plus disposable-root positive/fault-injection tests (T4.1-artifact, T4.3, T5.2, T6.4 evidence) | Staged, unreviewed by Codex |
| `T6_STAGED_EXECUTABLE_CHECKPOINT.md` | Staged-executable evidence, 52/52 passing tests, and explicit pending boundary | Pending Codex review |
