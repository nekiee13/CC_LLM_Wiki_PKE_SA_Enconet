...
## Slice 3 — handoff core (amended by M2_AMENDMENT_2.md: 7 creates + 1 generated modification)

Creating `HANDOFF.md` stales the generated board; amendment 2 authorizes the single
`coordination/BOARD.md` regeneration (installed CLI, reviewed timestamp) within this
slice so no committed state carries a stale board.
...
| `coordination/BOARD.md` **(generated modification)** | regenerated by installed `scripts/agent_coord.py --write-board --timestamp <reviewed UTC>` (M2_AMENDMENT_2.md) | Generated |
